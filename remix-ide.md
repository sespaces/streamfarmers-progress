...
============
2020, 28 January
  7:30am -- best result thus far is to serve index.html that fails to load "./build/app.js"; the file is there and permissioned correctly but fetch attempt yields 404 error
